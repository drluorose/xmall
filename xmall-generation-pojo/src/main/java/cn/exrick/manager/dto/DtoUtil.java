...
public class DtoUtil {
    ...
    public static Product TbItem2Product(TbItem tbItem) {
        ...
        product.setProductImageBig(splitTbItemImages(tbItem.getImage()).get(0));
    ...
    public static CartProduct TbItem2CartProduct(TbItem tbItem) {
        ...
        cartProduct.setProductImg(splitTbItemImages(tbItem.getImage()).get(0));
        if (tbItem.getLimitNum() == null) {
    ...
    public static List<String> splitTbItemImages(String tbItemImagesStr) {
        return Splitter.on(",").trimResults().omitEmptyStrings().splitToList(tbItemImagesStr);
    }
}
