...
public class TbOrderExample {
    ...
    protected abstract static class GeneratedCriteria {
        ...
        protected void addStatusCriterion(String condition, Object value, String property) {
            ...
            statusCriteria.add(new Criterion(condition, value, "cn.exrick.manager.mapper.handlers.OrderStatusEnumHandler"));
            allCriteria = null;
        }
        ...
        protected void addStatusCriterion(String condition, OrderStatusEnum value1, OrderStatusEnum value2, String property) {
            ...
            statusCriteria.add(new Criterion(condition, value1, value2, "cn.exrick.manager.mapper.handlers.OrderStatusEnumHandler"));
            allCriteria = null;
        }
