...
<configuration debug="true">
    ...
    <property name="appName" value="wsd-${projectName}-web-java" />
    ...
    <property name="FILE_PATH_STAT" value="/home/www/logs/applogs/${appName}/${HOSTNAME}-${appName}" />
    ...
    <!--<logger name="com.douyu" level="DEBUG">
        <appender-ref ref="CONSOLE_LOCAL" />
    </logger>-->
    </#noparse>
</configuration>